        ...
        .then(resolvedUrl => {
            return new Promise((resolve, reject) => {
                ...
                transport.get(parsedUrl.href, res => {
                    ...
                    const downloadingFileStream = fsExtra.createWriteStream(archivePath);
                    res.pipe(downloadingFileStream);
...
module.exports = {
    ...
    pull,
    push() {
        throw new Error('`http` backend is read-only, pushing is not implemented');
    },
